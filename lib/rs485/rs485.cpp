...
void armaCadenaValores(void)
{
    ...
    sprintf(cadena_a_enviar, "%i,%i,%i,%i,%i,%i,%i,%i,%i,%i,%i\n", num_modulo, modo_funcionamiento, (int)(Vcc * 10), (int)(Icc * 10), (int)Pot, (int)Temp1, (int)referencia, hs_FuncH, hs_FuncL, estadoEnsayo, alarmas);
